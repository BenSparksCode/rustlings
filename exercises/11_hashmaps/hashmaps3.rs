...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        // Update Team 1
        let team_scores: &mut TeamScores = scores.entry(team_1_name).or_insert(TeamScores {
            goals_scored: 0,
            goals_conceded: 0,
        });
        ...
        // Update Team 2
        let team_scores: &mut TeamScores = scores.entry(team_2_name).or_insert(TeamScores {
            goals_scored: 0,
            goals_conceded: 0,
        });
